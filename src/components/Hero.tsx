		...
		<section className='py-28 '>
			<div className='max-w-screen-xl mx-auto px-4 md:text-center md:px-8'>
				<div className='max-w-xl space-y-3 md:mx-auto'>
					...
					<p className='text-slate-800 dark:text-slate-200 text-3xl font-semibold sm:text-4xl'>
				...
				<div className='mt-4'>
					<a
						...
						className='inline-block py-2 px-4 text-white font-medium bg-slate-800 duration-150 hover:bg-slate-700 active:bg-slate-900 rounded-lg shadow-md hover:shadow-none'>
						Get started
					</a>
				</div>
			</div>
				...
				<div className='space-y-5 max-w-2xl mx-auto text-center xl:text-left'>
					<div className='flex flex-wrap items-center justify-center gap-6 xl:justify-start'>
						{features.map((item, idx) => (
							<div
								key={idx}
								className='flex items-center gap-x-2 dark:text-slate-300 text-sm'>
								{item.icon}
								{item.name}
							</div>
						))}
