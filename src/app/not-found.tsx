		...
		<main>
			<div className='max-w-screen-xl mx-auto px-4 flex items-center justify-start h-screen md:px-8'>
				<div className='max-w-lg mx-auto space-y-3 text-center'>
					...
					<p className='text-slate-100 text-4xl font-semibold sm:text-5xl'>
						Page not found
					</p>
					...
					<div className='flex flex-wrap items-center justify-center gap-3'>
						...
						<a
							href='/contact'
							className='block py-2 px-4 text-slate-300 hover:bg-gray-50 font-medium duration-150 active:bg-gray-100 border rounded-lg'>
							Contact support
						</a>
					</div>
				</div>
